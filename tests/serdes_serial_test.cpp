...
TEST_CASE("serial::serialize", "[CanAs]")
{
    ...
    checkSerialize<int32_t>({0, 0, 0, 0, 8, 0, ptLong, 0, 0, 0, 0, 0, 42}, 42);
    checkSerialize<uint32_t>({0, 0, 0, 0, 8, 0, ptUlong, 0, 0, 0, 0, 0, 42}, 42);
    checkSerialize<int16_t>({0, 0, 0, 0, 6, 0, ptShort, 0, 0, 0, 42}, 42);
    checkSerialize<uint16_t>({0, 0, 0, 0, 6, 0, ptUshort, 0, 0, 0, 42}, 42);
    checkSerialize<int16_t[2]>({0, 0, 0, 0, 8, 0, ptShort2, 0, 0, 0, 4, 0, 2}, {4, 2});
    ...
    checkSerialize<EmergencyData>({0, 0, 0, 0, 8, 0, ptError, 0, 0, 0, 1, 2, 3}, {1, 2, 3});
}
...
void checkDeserialize(const std::array<uint8_t, TSize> &data, const T &value)
{
    ...
    auto packet = deserialize<Packet<T>>(data2).value();
...
TEST_CASE("serial::deserialize", "[CanAs]")
{
    ...
    checkDeserialize<int32_t, 13>({0, 0, 0, 0, 4, 0, ptLong, 0, 0, 0, 0, 0, 42}, 42);
    checkDeserialize<uint32_t, 13>({0, 0, 0, 0, 4, 0, ptUlong, 0, 0, 0, 0, 0, 42}, 42);
    checkDeserialize<int16_t, 11>({0, 0, 0, 0, 2, 0, ptShort, 0, 0, 0, 42}, 42);
    checkDeserialize<uint16_t, 11>({0, 0, 0, 0, 2, 0, ptUshort, 0, 0, 0, 42}, 42);
    checkDeserialize<int16_t[2], 13>({0, 0, 0, 0, 4, 0, ptShort2, 0, 0, 0, 4, 0, 2}, {4, 2});
